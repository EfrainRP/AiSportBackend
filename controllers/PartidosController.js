...
// Update <- 
  export const update = async (req, res) => {
    ...
    console.log("TorneoId a editar:", torneoId);
  }
//--------------------------------------------------------------------------------------------
// STORE CREATE <-  
export const store = async (req, res) => {
  ...
  try {
    ...
    res.status(201).json({ message: 'Partido creado exitosamente con sus estadisticas', partido, estadistica_local, estadistica_visitante});
  } catch (error) {
